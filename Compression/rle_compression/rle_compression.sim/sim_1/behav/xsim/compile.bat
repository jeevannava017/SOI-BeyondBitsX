...
REM
REM Generated by Vivado on Wed Jul 08 16:12:49 +0530 2026
...
echo "xvlog --incr --relax -prj tb_rle_top_vlog.prj"
call xvlog  --incr --relax -prj tb_rle_top_vlog.prj -log xvlog.log
